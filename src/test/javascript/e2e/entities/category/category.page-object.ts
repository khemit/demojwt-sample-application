...
export class CategoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demojwtApp.category.delete.question'));
...
export default class CategoryComponentsPage {
  ...
  async deleteCategory() {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demojwtApp.category.delete.question/);
