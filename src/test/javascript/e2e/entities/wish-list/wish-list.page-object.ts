...
export class WishListDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demojwtApp.wishList.delete.question'));
...
export default class WishListComponentsPage {
  ...
  async deleteWishList() {
    ...
    expect(await wishListDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demojwtApp.wishList.delete.question/);
