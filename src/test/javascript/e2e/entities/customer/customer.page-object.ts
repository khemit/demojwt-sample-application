...
export class CustomerDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demojwtApp.customer.delete.question'));
...
export default class CustomerComponentsPage {
  ...
  async deleteCustomer() {
    ...
    expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demojwtApp.customer.delete.question/);
