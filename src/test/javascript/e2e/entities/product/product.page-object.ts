...
export class ProductDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demojwtApp.product.delete.question'));
...
export default class ProductComponentsPage {
  ...
  async deleteProduct() {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demojwtApp.product.delete.question/);
