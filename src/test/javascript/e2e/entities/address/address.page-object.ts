...
export class AddressDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('demojwtApp.address.delete.question'));
...
export default class AddressComponentsPage {
  ...
  async deleteAddress() {
    ...
    expect(await addressDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/demojwtApp.address.delete.question/);
