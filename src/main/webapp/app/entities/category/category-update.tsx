  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demojwtApp.category.home.createOrEditLabel">
            <Translate contentKey="demojwtApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="category-description">
                  <Translate contentKey="demojwtApp.category.description">Description</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="sortOrderLabel" for="category-sortOrder">
                  <Translate contentKey="demojwtApp.category.sortOrder">Sort Order</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="dateAddedLabel" for="category-dateAdded">
                  <Translate contentKey="demojwtApp.category.dateAdded">Date Added</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="dateModifiedLabel" for="category-dateModified">
                  <Translate contentKey="demojwtApp.category.dateModified">Date Modified</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="statusLabel" for="category-status">
                  <Translate contentKey="demojwtApp.category.status">Status</Translate>
                </Label>
                <AvInput
                  id="category-status"
                  type="select"
                ...
                >
                  <option value="AVAILABLE">{translate('demojwtApp.CategoryStatus.AVAILABLE')}</option>
                  <option value="RESTRICTED">{translate('demojwtApp.CategoryStatus.RESTRICTED')}</option>
                  <option value="DISABLED">{translate('demojwtApp.CategoryStatus.DISABLED')}</option>
                  <option value="PENDING">{translate('demojwtApp.CategoryStatus.PENDING')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="category-parent">
                  <Translate contentKey="demojwtApp.category.parent">Parent</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="category-product">
                  <Translate contentKey="demojwtApp.category.product">Product</Translate>
                </Label>
                <AvInput
                  id="category-product"
                  type="select"
