  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demojwtApp.customer.home.createOrEditLabel">
            <Translate contentKey="demojwtApp.customer.home.createOrEditLabel">Create or edit a Customer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : customerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="channelLabel" for="customer-channel">
                ...
                <AvInput
                  ...
                  name="channel"
                  value={(!isNew && customerEntity.channel) || 'EMAIL'}
                >
                  <option value="EMAIL">{translate('demojwtApp.NotificationType.EMAIL')}</option>
                  <option value="SMS">{translate('demojwtApp.NotificationType.SMS')}</option>
                  <option value="PARCEL">{translate('demojwtApp.NotificationType.PARCEL')}</option>
                </AvInput>
              </AvGroup>
