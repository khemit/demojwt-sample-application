  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="demojwtApp.address.home.createOrEditLabel">
            <Translate contentKey="demojwtApp.address.home.createOrEditLabel">Create or edit a Address</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : addressEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="countryLabel" for="address-country">
                  <Translate contentKey="demojwtApp.address.country">Country</Translate>
                </Label>
                <AvField
                  id="address-country"
                  type="text"
              ...
              <AvGroup>
                <Label for="address-customer">
                  <Translate contentKey="demojwtApp.address.customer">Customer</Translate>
                </Label>
