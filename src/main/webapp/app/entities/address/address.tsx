  ...
  return (
    <div>
      <h2 id="address-heading">
        <Translate contentKey="demojwtApp.address.home.title">Addresses</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="demojwtApp.address.home.createLabel">Create new Address</Translate>
        </Link>
      </h2>
        ...
        {addressList && addressList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('address1')}>
                  <Translate contentKey="demojwtApp.address.address1">Address 1</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('address2')}>
                  <Translate contentKey="demojwtApp.address.address2">Address 2</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="demojwtApp.address.city">City</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('postcode')}>
                  <Translate contentKey="demojwtApp.address.postcode">Postcode</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('country')}>
                  <Translate contentKey="demojwtApp.address.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="demojwtApp.address.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="demojwtApp.address.home.notFound">No Addresses found</Translate>
            </div>
          )
        )}
      </div>
